...
_kpl_swarm_complete() {
    ...
    case $command_name in
        ...
        init|configure)
            ...
            _kpl_swarm_offer KPL_STACK_NAME= KPL_CONTROL_NODE_ID= KPL_PEER_NETWORK= KPL_PEER_SUBNET= KPL_IMAGE= KPL_AGENT_CAPACITY= KPL_AGENT_METRICS_PORT= KPL_USER= KPL_PASSWORD= GRAFANA_ADMIN_USER= GRAFANA_ADMIN_PASSWORD= KPL_HTTP_PORT= PROMETHEUS_PORT= GRAFANA_PORT= KPL_MIN_AGENTS= KPL_DOCKER_TIMEOUT= KPL_IMAGE_BUILD_TIMEOUT= KPL_IMAGE_PUSH_TIMEOUT= KPL_IMAGE_PULL_TIMEOUT= KPL_CONTROLLER_STOP_TIMEOUT= KPL_AGENT_STOP_TIMEOUT=
            ;;
    esac
    return 0
}
